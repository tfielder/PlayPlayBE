...
const playlist_ranking = (playlist_id) => {
  ...
  // select avg(song_rating) from songs inner join playlist_songs on songs.id = playlist_songs.song_id where playlist_songs.playlist_id = 165;
}

const sort_by_playlist = (playlists) => {
